...
import ctaBg from "../assets/Jimam Final/4.webp";
import "animate.css";
...
const Homepage = () => {
  ...
  const products = [
    {
      ...
      image: brick1,
      description:
        "Premium quality classic clay bricks for all construction needs",
      alt: "Classic Clay bricks - Bricks 1/1.jpg",
    },
    {
      name: "Modern Clay Brick",
      image: brick2,
      description: "Modern clay bricks for stylish and durable builds",
      alt: "Modern Clay bricks - Bricks 1/2.jpg",
    },
    {
  ...
  return (
    <div className="pt-16 lg:pt-20">
      <Helmet>
        <title>Premium Clay Bricks & Blocks in Ghana | Jimam Bricks</title>
        <meta
          name="description"
          content="Jimam Bricks supplies high-quality clay bricks, blocks, and building materials across Ghana. Trusted by contractors and homeowners since 2019."
        />
        <link rel="canonical" href="https://jimambricks.com/" />
      </Helmet>
      ...
      <section className="relative text-brand-white overflow-hidden min-h-screen flex items-center">
        {heroVideos.map((video, idx) => (
          <video
            key={video}
            className={`absolute inset-0 w-full h-full object-cover overflow-hidden transition-all duration-1000 ${
            ...
            loop
            playsInline
            aria-hidden={Boolean(idx !== currentHero)}
          />
        ))}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32 z-30 text-center">
          <div className="max-w-3xl">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl mb-8 text-brand-white leading-relaxed">
              Premium clay bricks and building materials for contractors,
              builders, and homeowners. Quality you can trust, craftsmanship
              that lasts.
            </p>
            ...
            className={`w-3 h-3 rounded-full border-2 border-brand-white transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-brand-blue
              ${
                currentHero === idx
                  ...
                  : "bg-brand-white/60 hover:bg-brand-blue/60"
              }`}
            style={{ outline: "none" }}
          />
        ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-black max-w-3xl mx-auto px-4 animate__animated animate__lightSpeedInRight animate__slower">
              Discover our range of premium building materials crafted for
            ...
            {products.map((product, index) => (
              ...
              >
                ...
                <div className="p-4 sm:p-6">
                  <h3 className="text-lg sm:text-xl font-semibold text-[#650909] mb-2">
                    {product.name}
                  </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-black max-w-3xl mx-auto px-4">
              We've been the trusted choice for quality building materials for
              nearly four decades
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 ">
            {features.map((feature, index) => (
              <div
                key={index}
                className="text-center group p-4 sm:p-6 bg-brand-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-black hover:border-[#650909]"
              >
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-[#650909] mb-3 sm:mb-4">
                  {feature.title}
                </h3>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-brand-white mb-6 sm:mb-8 max-w-3xl mx-auto px-4 leading-relaxed relative z-10">
            Ready to build something amazing? Get in touch with our team for a
            free consultation and quote on your next construction project.
          </p>
